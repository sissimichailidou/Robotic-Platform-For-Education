...
Blockly.Msg.ADD_COMMENT = "Σημείωση";
Blockly.Msg.AUTH = "Εξουσιοδότηση εφαρμογής";
Blockly.Msg.CHANGE_VALUE_TITLE = "Αλλαγή τιμής";
Blockly.Msg.CHAT = "Στείλε μήνυμα";
Blockly.Msg.COLLAPSE_ALL = "Ελαχιστοποίηση όλων";
Blockly.Msg.COLLAPSE_BLOCK = "Ελαχιστοποίηση";
...
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "Εάν είναι ψέμα, κάνε";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "Εναλλακτικά, εάν αληθεύει";
Blockly.Msg.CONTROLS_IF_MSG_IF = "Εάν αληθεύει";
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = "Επανέλαβε %1 φορές";
...
Blockly.Msg.VARIABLES_DEFAULT_NAME = "Όνομα μεταβλητής";
